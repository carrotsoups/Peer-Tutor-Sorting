    ...
    return (
        <div style={{ padding: '2rem' }}>
            ...
            <p style={{ fontSize: '1.1rem', lineHeight: '1.6', marginBottom: '2rem', maxWidth: '800px' }}>
                This application helps educational institutions efficiently match peer tutors with students based on their availability, 
                grade levels, and scheduling preferences. Upload your Google Sheets data containing tutor and student information, 
                then use our intuitive drag-and-drop interface to create optimal tutoring schedules. The app also features an 
                intelligent auto-scheduling algorithm that automatically pairs tutors and students while respecting grade compatibility 
